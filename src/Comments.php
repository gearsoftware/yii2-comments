...
namespace gearsoftware\comments;
...
class Comments extends \yii\base\Module
{
     ...
     * @var string
     */
    public $controllerNamespace = 'gearsoftware\comments\controllers';
     ...
     * 
     * Note! `gearsoftware\comments\components\Akismet` component must be configured:
     * 
     * ~~~
     * 'components' => [
     *     'akismet' => [
     *         'class' => 'gearsoftware\comments\components\Akismet',
     *         'apiKey' => '*******',
     *     ],
     * ]
     * ~~~
     ...
     * ~~~
     * 'comments' => [
     *       'class' => 'gearsoftware\comments\Comments',
    ...
    public function registerTranslations()
    {
        Yii::$app->i18n->translations['yii2-comments/*'] = [
            ...
            'basePath' => '@vendor/gearsoftware/yii2-comments/messages',
            'fileMap' => [
    ...
    public static function getMultilingUrl($url)
    {
        ...
        $languageRedirects = Yii::$app->core->languageRedirects;
