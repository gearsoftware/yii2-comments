...
namespace gearsoftware\comments\components;
...
class CommentsHelper
{
     ...
     * @return array
     */
    public static function getCacheProperties($model, $model_id = '', $duration = 1)
    {
     ...
     *
     * @param \gearsoftware\comments\models\Comment $comment
     * @return array
     */
